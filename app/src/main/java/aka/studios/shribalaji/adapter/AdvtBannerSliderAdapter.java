...
public class AdvtBannerSliderAdapter extends PagerAdapter {

    Context context;
    MainActivity activity;
    ArrayList<AdvtBanner> bannerArrayList;

    public AdvtBannerSliderAdapter(Context context, MainActivity activity, ArrayList<AdvtBanner> bannerArrayList) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        imageLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activity.getAdvtBannerId(position);
            }
        });
