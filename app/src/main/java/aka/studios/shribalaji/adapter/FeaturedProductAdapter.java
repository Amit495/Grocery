...
public class FeaturedProductAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    ...
    public FeaturedProductAdapter(Context context, MainActivity activity, ArrayList<Product> productArrayList) {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.featured_product_layout, parent, false);
