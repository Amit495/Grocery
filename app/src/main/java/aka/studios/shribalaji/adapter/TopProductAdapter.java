...
public class TopProductAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    ...
    public TopProductAdapter(Context context, MainActivity activity, ArrayList<Product> productArrayList) {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.top_product_layout, parent, false);
                        ...
                        if (response.code() == 200) {
                            try {
                                ...
                                if (!jsonObject.getBoolean("error")) {
                                    ...
                                    activity.updateTopItem(position, data.getInt("quantity") + 1);
                                    notifyDataSetChanged();
