...
import aka.studios.shribalaji.activity.ProceedActivity;
...
public class ProceedAddressAdapter extends RecyclerView.Adapter<AddressViewHolder> {
    ...
    public ProceedAddressAdapter(Context context, ProceedActivity activity, ArrayList<Address> addressArrayList) {
    ...
    public void onBindViewHolder(@NonNull AddressViewHolder holder, int position) {
        ...
        if (currentPosition == position) {
            ...
            activity.selectedAddress(position);
        }
        else {
