...
public class ProductDetailSliderAdapter extends PagerAdapter {
    ...
    public ProductDetailSliderAdapter(Context context, ArrayList<Image> imageArrayList) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        View imageLayout = LayoutInflater.from(context).inflate(R.layout.detail_banner_slider, view, false);
